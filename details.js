...
let subImg1 = document.getElementById("subimg-1")
let subImg2 = document.getElementById("subimg-2")
let subImg3 = document.getElementById("subimg-3")
let subImg4 = document.getElementById("subimg-4")
...
console.log("finded product : ", findedProduct)


myTitle.textContent = findedProduct.productName
category.textContent = findedProduct.category
longdescription.textContent = findedProduct.longDescription
myprice.textContent = findedProduct.price
mainImg.src = findedProduct.image
subImg1.src = findedProduct.img1
subImg2.src = findedProduct.img2
subImg3.src = findedProduct.img3
